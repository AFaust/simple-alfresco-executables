 ...
 * @author Axel Faust
 */
public class RepoClassPathStorePostProcessor implements BeanFactoryPostProcessor, InitializingBean
{
    ...
    public void postProcessBeanFactory(final ConfigurableListableBeanFactory beanFactory) throws BeansException
    {
        for (final String beanName : this.beanNames)
        {
            if (beanFactory.containsBean(beanName))
            {
                ...
                if (beanClassName == null || beanClassName.equals(RepoClassPathStore.class.getName()))
                {
                    beanDefinition.setBeanClassName(FatJarAwareRepoClassPathStore.class.getName());
                }
            }
        }
    }
