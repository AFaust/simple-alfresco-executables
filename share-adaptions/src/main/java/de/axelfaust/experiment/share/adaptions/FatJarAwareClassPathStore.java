 ...
 * @author Axel Faust
 */
public class FatJarAwareClassPathStore extends ClassPathStore
{
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(FatJarAwareClassPathStore.class);
